...
<div class="tkct-right">
    ...
    <form action="{{ route('dmkSave') }}" method="POST" class="tkct-form">
        ...
        <div class="form-box">
            ...
            <input id="name" type="password" placeholder="Nhập mật khẩu hiện tại" name="pass">
        </div>

        <div class="form-box">
            <label for="sdt">Mật khẩu mới</label>
            <input id="sdt" type="password" placeholder="Nhập mật khẩu mới" name="newPass" id="newPass">
        </div>

        <div class="form-box">
            <label for="email">Nhập lại mật khẩu</label>
            <input id="email" type="password" placeholder="Nhập lại mật khẩu mới" name="passNew">
        </div>
        @if($errors->has('passs'))
