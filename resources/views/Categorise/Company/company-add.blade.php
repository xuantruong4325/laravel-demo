	...
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
			<div class="pd-20 card-box mb-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue h3">Thêm hãng</h4>
					</div>
				</div>
				<form action="{{ route('addCompanySave') }}" method="POST">
					@csrf

					<div class="form-group">
						<h6 class="mb-3">Nhập hãng</h6>
...
@if(session('redirect'))
<script>
	Swal.fire('Thêm mới hãng sản phẩm thành công', '', 'success')
	setTimeout(function() {
