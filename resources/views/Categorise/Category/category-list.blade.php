                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="{{ route('deleteCategory', ['id' => $category->id]) }}" onclick="deleteUser()"><i class="dw dw-delete-3"></i> Xóa</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<script>
	function deleteUser() {
        Swal.fire('Xóa loại sản phẩm thành công', '', 'success')
    }
</script>
@endsection