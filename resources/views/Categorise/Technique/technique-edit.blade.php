			...
			<div class="pd-20 card-box mb-30">
				...
				<form action="{{ route('editTechniqueSave', ['id' => $technique->id]) }}" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" name="technique" class="form-control form-control-lg" value="{{ $technique->technique }}" required />
					</div>
...
@if(session('redirect'))
<script>
	Swal.fire('Sửa thông số sản phẩm thành công', '', 'success')
	setTimeout(function() {
